...
# 读入数据
default = pd.read_excel(r'C:\Users\Lenovo\Desktop\default of credit card.xls')
...
# 返回参数的最佳组合和对应AUC值
print(base_model.best_params_, base_model.best_score_)
...
# 返回参数的最佳组合和对应AUC值
print(gbdt_grid.best_params_, gbdt_grid.best_score_)
...
# 读入数据
creditcard = pd.read_csv(r'C:\Users\Lenovo\Desktop\creditcard.csv')
# 为确保绘制的饼图为圆形，需执行如下代码
plt.axes(aspect = 'equal')
# 统计交易是否为欺诈的频数
